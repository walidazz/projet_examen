...
<li class="active">Article Récent</li>
</ol>
            ...
            <li class=" bg-article list-group-item  mb-2 bg-article text-dark view zoom " style="color:white;" >
                <div class="row ">
                    ...
                    <div class="col-xs-2 col-md-2 p-1  ">
                        <img style="height:150px;width:150px; " src="<?= WEBROOT. $article->getImg() ?>" class="border border-white img-circle img-responsive imgArticle" alt="image article" /></div>
...
<nav  aria-label="Page">
  <ul  class="pagination float-right bg-light">
 
  <?php 	for($i=1; $i<=$nbPage; $i++){
	  if($i == $current){ ?>
	  <li  class="page-item " style="opacity:0.5;"><a class="page-link active" href="<?= WEBROOT?>Article/news/<?=$i?>"> <?=$i?>   </a></li> <?php }  else {?>
<li class="page-item bg-grey"><a class="page-link" href="<?= WEBROOT?>Article/news/<?=$i?>"> <u> <?=$i?></u> </a></li> <?php } } ?>
  </ul>
</nav>
    ...
    <div class="col-sm-2 sidenav "> 
         <a  href="<?= WEBROOT ?>Article/create"  class="mx-auto "> 
